...
DOMAIN4 = [
    dict(
        ...
        steps=[
            ("Write your top root cause from Lab 3 at the top of templates/countermeasure-brainstorm-template.csv — every idea must address THIS cause.", ""),
        ...
        debrief_check='Every group can show a countermeasure that addresses the Lab 3 root cause, a completed impact/effort grid with one selection, numbered standard work with a done/not-done check, and a pilot plan naming a measure, an owner and a review date.',
