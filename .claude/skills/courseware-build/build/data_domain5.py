"""
Activity 5 — CONTROL phase. Closes the BrewBean Cafe running scenario.
...
DOMAIN5 = [
    dict(
        ...
        steps=[
            ...
            ("In templates/sop-and-huddle-template.csv, turn your Activity 4 standard work into a short SOP the cafe could actually pin up.", ""),
