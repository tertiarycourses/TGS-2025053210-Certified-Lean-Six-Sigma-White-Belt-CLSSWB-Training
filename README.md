...
| Artifact | File |
|----------|------|
| **Slide deck** | `courseware/Certified Lean Six Sigma White Belt (CLSSWB) Training-v4.pptx` (and `.pdf`) |
...
*Version v4 · 23 September 2026 · © 2026 Tertiary Infotech Academy Pte Ltd*
